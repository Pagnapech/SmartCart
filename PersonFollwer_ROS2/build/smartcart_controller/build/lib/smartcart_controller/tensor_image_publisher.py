...
#             print(f'itemName: ' + itemName)
            ...
            if msgtest != [0, 0]:
                msg.data = [cx - position, cy]
                cxtemp = cx - position
                cytemp = cy
            else:
                msg.data = [cxtemp, cytemp]
            
            # Object position in the center
        ...
        # Draw Line 1
        # utilities.drawLine(frame, LINE1_xS, LINE1_y, LINE1_xS, LINE2_y, CYAN, LINE_THICKNESS)
        # Draw Line 2 
